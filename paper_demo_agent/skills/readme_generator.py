...
class ReadmeGeneratorSkill(BaseSkill):
    ...
    def get_system_prompt(
        ...
        return f"""You are a world-class open-source maintainer who writes READMEs that make
...
"""
    ...
    def get_initial_message(
        ...
        return f"""Build a publication-quality GitHub README.md for: "{paper.title}"
