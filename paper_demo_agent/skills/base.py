...
FORM_SPECS: dict[str, dict] = {
    "app": {
        ...
        "must": [
            ...
            "Ensure visual contrast in custom CSS and charts: header title/body/link text and plotted annotations must remain clearly readable on their backgrounds",
    ...
    "app_streamlit": {
        ...
        "forbidden": [
            ...
            "Do NOT use deprecated `use_column_width` — use `use_container_width=True` instead",
