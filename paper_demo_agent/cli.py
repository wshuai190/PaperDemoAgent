...
@click.option("--form", "-f", default=None,
              type=click.Choice(["app", "presentation", "page", "diagram", "website", "slides", "latex", "flowchart", "flowchart_pro"]),
              help="Demo form (app, presentation, website, page, diagram, slides, latex, flowchart, flowchart_pro)")
